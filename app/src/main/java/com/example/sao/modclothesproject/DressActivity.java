...
public class DressActivity extends AppCompatActivity {
    ...
    private void selectolder(){
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(DressActivity.this, ViewImage.class);
    ...
    private void tackphoto(){
        ...
        File image = new File(imagesFolder, "Dress_" + timeStamp + ".png");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent i = new Intent(DressActivity.this, MainActivity.class);
            startActivity(i);
        }
