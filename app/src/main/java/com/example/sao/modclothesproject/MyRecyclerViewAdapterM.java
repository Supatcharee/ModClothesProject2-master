...
/**
 * Created by Sao on 5/6/2016.
 */
public class MyRecyclerViewAdapterM  extends RecyclerView.Adapter<MyRecyclerViewAdapterM.ItemHolder>{
    ...
    public MyRecyclerViewAdapterM(Context context, MActivity mActivity){
    ...
    private Bitmap loadScaledBitmap(Uri src) throws FileNotFoundException {
        ...
        mActivity.textInfo.append(src.getLastPathSegment() + "\n");
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private MyRecyclerViewAdapterM parent;
        private CardView cardView;
        ImageView imageView;
        String itemUri;

        public ItemHolder(CardView cardView, MyRecyclerViewAdapterM parent) {
            super(cardView);
