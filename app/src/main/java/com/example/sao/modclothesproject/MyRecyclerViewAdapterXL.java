 ...
 */
public class MyRecyclerViewAdapterXL extends RecyclerView.Adapter<MyRecyclerViewAdapterXL.ItemHolder> {

    private List<Uri> itemsUri;
    private LayoutInflater layoutInflater;
    private Context context;
    private OnItemClickListener onItemClickListener;
    XLActivity xlActivity;

    public MyRecyclerViewAdapterXL(Context context, XLActivity xlActivity){
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
        itemsUri = new ArrayList<Uri>();

        this.xlActivity = xlActivity;
    }
    ...
    private Bitmap loadScaledBitmap(Uri src) throws FileNotFoundException {
        ...
        xlActivity.textInfo.append(src.getLastPathSegment() + "\n");
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private MyRecyclerViewAdapterXL parent;
        private CardView cardView;
        ImageView imageView;
        String itemUri;

        public ItemHolder(CardView cardView, MyRecyclerViewAdapterXL parent) {
            super(cardView);
