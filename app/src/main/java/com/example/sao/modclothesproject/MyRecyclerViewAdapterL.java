 ...
 */
public class MyRecyclerViewAdapterL extends RecyclerView.Adapter<MyRecyclerViewAdapterL.ItemHolder> {
    ...
    public MyRecyclerViewAdapterL(Context context, LActivity lActivity){
    ...
    private Bitmap loadScaledBitmap(Uri src) throws FileNotFoundException {
        ...
        lActivity.textInfo.append(src.getLastPathSegment() + "\n");
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private MyRecyclerViewAdapterL parent;
        private CardView cardView;
        ImageView imageView;
        String itemUri;

        public ItemHolder(CardView cardView, MyRecyclerViewAdapterL parent) {
            super(cardView);
